...
import { truncateConversationIfNeeded, estimateTokenCount } from "../sliding-window"
...
import { ContextSynthesizer } from "../../services/synthesization/ContextSynthesizer"
...
export class Task extends EventEmitter<ClineEvents> {
	...
	constructor({
		...
		contextSummarizationInitialStaticTurns = 3,
		contextSummarizationRecentTurns = 3,
	}: TaskOptions) {
		super()
